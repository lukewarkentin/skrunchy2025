...
sigma_P_1984_2020 <- readRDS( here("data-raw/tyee-data-1984-2020/sigma-P-1984-2020.rda"))
...
sigma_P_1984_2020_df <- array2DF( P_1984_2020, responseName = "sigma_P")
ds1984_2020 <- merge( P_1984_2020_df, sigma_P_1984_2020_df, by = c("w", "y", "i"), all= TRUE)
...
d1l$i <- ifelse( d1l$CU_NAME %in% k$cu_snp,
...
stat_wk_key <- read_xlsx( here("data-raw/stat-week-calculator-2021.xlsx"), skip = 2 , .name_repair = "universal")
str(stat_wk_key)
