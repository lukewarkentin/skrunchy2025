...
[This methods document](https://github.com/Pacific-salmon-assess/skrunchy/blob/main/inst/methods.pdf) contains detailed methods, variables, and equations matching this package as much as possible. 
...
Use data from Skeena Tyee test fishery weekly catch and genetic mixture data, and pool it into annual genetic proportions. 
...
```{r N, dpi=300, fig.width = w,fig.height=h}
...
```{r R, dpi=300, fig.width = w,fig.height=h}
# R <- get_R( N = N$N )
