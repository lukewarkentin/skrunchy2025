...
Use data from Skeena Tyee test fishery weekly catch and genetic mixture
data, and pool it into annual genetic proportions.
...
ggplot(p_proportion_wild$df, aes(y = p, x = y, group = i)) +
  geom_point() +
  geom_line() +
  facet_grid(i~a) +
